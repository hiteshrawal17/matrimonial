  ...
  <div class="container">
   ...
   <div class="profile">
			...
			<div class="col-sm-8 row_1">
			   <?php
			     ...
			     if(isset($_GET["missmatch"])){
					 echo"<div class='alert alert-danger'>New Password and Retpye Password not same</div>";
				 }
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_value"><input type="password" name="cp" class="form-control" required><br></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">New Password :</td>
							<td class="day_value"><input type="password" name="np" class="form-control" required><br></td>
						</tr>
					    <tr class="opened">
					    ...
					    <tr class="closed">
							<td class="day_label" colspan=2><br><input type="submit" value="Submit" class="btn btn-warning" style="float:right"></td></tr>						
				    </tbody>
				</table>
				</form>
			</div>
     ...
     <div class="col-md-4 profile_right">
	  ...
	  <input type="text" id ="search" placeholder="Search User By Name , ID">
        </div>
