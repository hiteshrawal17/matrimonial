...
<div class="grid_3">
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        <a href="profile"><i class="fa fa-home home_1"></i></a>
   ...
   <div class="profile">
   	 <div class="col-md-8 profile_left">
			...
			?>
			 <div class="alert alert-danger">Image Not Updated..... Try Again</div>			 
			<?php
			  }
			  if(isset($_GET["empty"])){
			?>
			...
			<form method="post" action="update.php">
				<table class="table_working_hours">
		        	<tbody>
						...
						<tr><td colspan=2><br><input type="submit" value="Update" class="btn btn-primary" style="float:right"></td></tr>
				    </tbody>
				</table>
				</form>
