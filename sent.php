		    ...
		    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
			   ...
			   <div id="myTabContent" class="tab-content">
				  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
					...
					<?php
					    $rs=mysqli_query($conn,"select * from inbox where email='$email'");
						while($r=mysqli_fetch_array($rs)){
							$flag=1;
							$rc=mysqli_query($conn,"select * from details where email='".$r["to_email"]."'");
							$rec=mysqli_fetch_array($rc);
					?>
					
	                <div class="jobs-item with-thumb">
	                   <div class="thumb_top">
				        <div class="thumb"><a href="user_profile.php?id=<?=$r["to_code"]?>" ><img src="images/p13.jpg" class="img-responsive" alt=""/></a></div>
					    <div class="jobs_right">
							<h6 class="title"><a  href="user_profile.php?id=<?=$r["to_code"]?>" ><?=$rec["fname"]." ".$rec["lname"]?></a></h6>
					   ...
					   <div class="thumb_bottom">
					   	   ...
					   	   <div class="thumb_but"><a href="user_profile.php?id=<?=$r["to_code"]?>" class="photo_view">View Profile</a></div>
					   	  <div class="clearfix"> </div>
					   </div>
					  </div>
